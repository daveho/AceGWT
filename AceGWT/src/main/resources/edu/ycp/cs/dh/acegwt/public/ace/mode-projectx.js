// START -- define('ace/mode/projectx_highlight_rules')
define('ace/mode/projectx_highlight_rules', function(require, exports, module) {

var oop = require("ace/lib/oop");
var TextHighlightRules = require("ace/mode/text_highlight_rules").TextHighlightRules;

/* --------------------- START ----------------------------- */
var ProjectxHighlightRules = function() {
this.$rules = {
"start" : [
   {
      "token" : ["comment.line"],
...
oop.inherits(ProjectxHighlightRules, TextHighlightRules);
exports.ProjectxHighlightRules = ProjectxHighlightRules;
}
); //END -- define('ace/mode/projectx_highlight_rules')
...
define(
	"ace/mode/projectx",
	["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/projectx_highlight_rules","ace/range"],
	function(require, exports, module) {
		"use strict";
		var oop                  = require("../lib/oop");
		var TextMode             = require("./text").Mode;
		var Range                = require("../range").Range;
		var ProjectxHighlightRules = require("./projectx_highlight_rules").ProjectxHighlightRules;
		var Mode = function() {
			this.HighlightRules = ProjectxHighlightRules;
		};
		oop.inherits(Mode, TextMode);
		(function() {
			this.lineCommentStart = "//";
			this.$id = "ace/mode/projectx";
		}).call(Mode.prototype);
		exports.Mode = Mode;
	}
);
